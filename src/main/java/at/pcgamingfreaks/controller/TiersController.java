...
public class TiersController {
    ...
    private ResponseEntity<List<Tier>> tierlist(@PathVariable String username, @PathVariable Service service, @PathVariable ContentType type) throws InterruptedException {
